...
public sealed partial class MedicalRecordsMenu : FancyWindow
{
    ...
    private void PopulateInformation(FullCharacterRecords record)
    {
        ...
        RecordContainerSpecies.Text = Loc.GetString(_prototypeManager.Index<SpeciesPrototype>(record.Species).Name);
        RecordContainerAge.Text = record.Age.ToString();
        RecordContainerHeight.Text = cr.Height + " " + Loc.GetString("funky-medical-records-unit-cm");
        RecordContainerWeight.Text = cr.Weight + " " + Loc.GetString("funky-medical-records-unit-kg");
